...
def getDependencyListOut():
    ...
    # print "Data sent after t = t1, y0part0, y1part0, ..... ",
    # print "Dependency_in: "
    # print dependency_in 

def getDependencyListIn():
    dependency_in = []
    # Inserting the connections between Line node i and all the Point nodes it is connected to, except itself
    for i in range(numCores):
...
for i in tlist:
    print "Solving at time t=",i
    if i==0:
        dependency = getDependencyListIn()      # This is the equvalent of data flow graph, here generated for the MatrixVector Application
    else:
        dependency = getDependencyListOut()

    commodities = init_commodity(dependency)    # Initiate list of commodity, data structure for lp, of the form 's2d4' source processor 2, destination 4
    ...
    arc = init_arc_list_()                      # List of arc tuples generated from mesh network specification
    ...
    arc_list = arc_list + init_arc_list(arc_solution)
...
printToFile(arc_list, "Lookupmct")
